...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-maintenance-mode-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11002&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-maintenance-mode-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-maintenance-mode` can be installed with:

```
conda install django-maintenance-mode
```

It is possible to list all of the versions of `django-maintenance-mode` available on your platform with:
